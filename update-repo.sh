...
git fetch ssh://trond@review.couchbase.org:29418/tlm refs/changes/43/26543/22 && git cherry-pick FETCH_HEAD
cd ..
cd libvbucket
git fetch ssh://trond@review.couchbase.org:29418/libvbucket refs/changes/96/26096/10 && git cherry-pick FETCH_HEAD
cd ..
cd memcached
git fetch ssh://trond@review.couchbase.org:29418/memcached refs/changes/13/26113/28 && git cherry-pick FETCH_HEAD
cd ..
cd libconflate
