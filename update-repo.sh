...
cd tlm
git fetch ssh://trond@review.couchbase.org:29418/tlm refs/changes/43/26543/18 && git cherry-pick FETCH_HEAD
cd ..
cd libvbucket
git fetch ssh://trond@review.couchbase.org:29418/libvbucket refs/changes/96/26096/9 && git cherry-pick FETCH_HEAD
cd ..
cd memcached
git fetch ssh://trond@review.couchbase.org:29418/memcached refs/changes/13/26113/24 && git cherry-pick FETCH_HEAD
cd ..
cd libconflate
git fetch ssh://trond@review.couchbase.org:29418/libconflate refs/changes/29/26929/2 && git cherry-pick FETCH_HEAD
cd ..
cd couchstore
git fetch ssh://trond@review.couchbase.org:29418/couchstore refs/changes/61/26861/10 && git cherry-pick FETCH_HEAD
cd ..
cd libmemcached
